...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen w-full grid grid-cols-1 md:grid-cols-2">
      {/* Left Panel */}
      <div className="hidden md:flex flex-col justify-between p-12 bg-[#1a1a2e] text-center">
        <div className="self-start">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-2xl font-bold text-white">Smart Link Admin</span>
          </div>
        </div>
        <div className="flex flex-col gap-6">
          ...
          <h2 className="text-gray-300 text-base font-normal leading-normal">
            Secure access to platform administration and user management.
          </h2>
        </div>
        <div></div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 mt-2">
              <button
                type="submit"
                disabled={loading}
                className="h-12 w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {loading ? (
                  <>
