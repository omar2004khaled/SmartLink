...
import { login, initiateGoogleLogin, handleGoogleCallback } from '../services/services';
...
const Login = () => {
  ...
  useEffect(() => {
    const handleOAuthCallback = async () => {
      // Check if we're on a callback URL (has token or error params)
  ...
  // Simply redirect to Google OAuth - callback will be handled by useEffect
  const handleGoogleLogin = () => {
    console.log('Initiating Google login...');
    initiateGoogleLogin();
    navigate("/PostComposation")
  };
      ...
      <div className="flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-background">
        <div className="w-full max-w-md flex flex-col gap-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <label className="flex flex-col gap-2">
              ...
              <input
                ...
                required
                disabled={loading}
                className="h-12 px-4 rounded-lg border border-input bg-muted/30 focus:bg-background focus:border-ring focus:ring-2 focus:ring-ring/20 text-foreground placeholder:text-muted-foreground transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <label className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  disabled={loading}
                  className="h-12 w-full px-4 pr-12 rounded-lg border border-input bg-muted/30 focus:bg-background focus:border-ring focus:ring-2 focus:ring-ring/20 text-foreground placeholder:text-muted-foreground transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button
                  ...
                  disabled={loading}
                  className="absolute right-0 top-0 h-12 px-4 text-muted-foreground hover:text-foreground transition-colors disabled:opacity-50"
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 h-12 px-4 rounded-lg border border-[#CCCCCC] dark:border-[#444444] hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
