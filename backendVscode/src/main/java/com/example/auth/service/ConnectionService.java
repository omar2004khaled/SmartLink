...
public class ConnectionService {
    ...
    public ConnectionDto acceptRequest(Long connectionId, Long userId) {
        ...
        notificationService.createConnectionAcceptedNotification(
                ...
                userId,
                connection.getReceiver().getFullName());
    ...
    public List<ConnectionDto> getPendingRequests(Long userId) {
        return connectionRepo.findByUserIdAndStatus(userId, ConnectionStatus.PENDING).stream().map(this::toDto)
                .collect(Collectors.toList());
    }

    @Transactional(readOnly = true)
    public List<ConnectionDto> getConnections(Long userId) {
        return connectionRepo.findByUserIdAndStatus(userId, ConnectionStatus.ACCEPTED).stream().map(this::toDto)
                .collect(Collectors.toList());
    }
